...
CREATE TABLE `assessmentinformation` (
  ...
  `problem_presented` text COLLATE utf8_general_ci,
  `social_worker_assessment` text COLLATE utf8_general_ci,
  `client_category` int NOT NULL,
  `client_sub_category` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `assistanceinformation` (
  ...
  `referral_specify` text COLLATE utf8_general_ci,
  `other` text COLLATE utf8_general_ci,
  `amount` decimal(10,2) DEFAULT NULL,
  `mode_of_assistance` enum('Cash','GL') COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `specify` text COLLATE utf8_general_ci,
  `value_pesos` decimal(10,2) DEFAULT NULL,
  `fund_source` text COLLATE utf8_general_ci,
  ...
  `material_specify` text COLLATE utf8_general_ci,
  `material_value_pesos` decimal(10,2) DEFAULT NULL,
  `payee_name` text COLLATE utf8_general_ci,
  `payee_address` text COLLATE utf8_general_ci,
  PRIMARY KEY (`id`),
  KEY `client_id` (`client_id`),
...
CREATE TABLE `beneficiaryfamilycomposition` (
  ...
  `sex` enum('Male','Female') COLLATE utf8_general_ci DEFAULT NULL,
  `relationship` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `civil_status` enum('Single','Married','Other') COLLATE utf8_general_ci DEFAULT NULL,
  `civil_status_other` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `beneficiaryinformation` (
  ...
  `client_id` int DEFAULT NULL,
  `beneficiary_type` set('FHONA','Solo Parent','PWD','4Ps','Others') COLLATE utf8_general_ci DEFAULT NULL,
  `other_beneficiary_type` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `youth_senior` set('Youth','Senior Citizen') COLLATE utf8_general_ci DEFAULT NULL,
  `last_name` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `first_name` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `middle_name` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `ext_name` varchar(10) COLLATE utf8_general_ci DEFAULT NULL,
  `sex` enum('Male','Female') COLLATE utf8_general_ci DEFAULT NULL,
  `date_of_birth` date DEFAULT NULL,
  `age` int DEFAULT NULL,
  `birth_place` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `region` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `province` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `city_municipality` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `district` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `barangay` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `street_purok` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `contact_number` varchar(15) COLLATE utf8_general_ci DEFAULT NULL,
  `civil_status` enum('Single','Married','Other') COLLATE utf8_general_ci DEFAULT NULL,
  `civil_status_other` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `clientinformation` (
  ...
  `middle_name` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `ext_name` varchar(10) COLLATE utf8_general_ci DEFAULT NULL,
  `id_number` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `sex` enum('Male','Female') COLLATE utf8_general_ci DEFAULT NULL,
  `date_of_birth` date DEFAULT NULL,
  `age` int DEFAULT NULL,
  `birth_place` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `barangay` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `street_purok` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `relationship_to_beneficiary` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `civil_status` enum('Single','Married','Other') COLLATE utf8_general_ci DEFAULT NULL,
  `civil_status_other` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `nationality` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `skills_occupation` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `philhealth_no` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `mode_of_admission` enum('Walk-in','Referral') COLLATE utf8_general_ci DEFAULT NULL,
  `referring_party` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `contact_number` varchar(15) COLLATE utf8_general_ci DEFAULT NULL,
  `last_assistance_date` date DEFAULT NULL,
...
CREATE TABLE `educationalattainment` (
  ...
  `education_level` varchar(100) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `idtypes` (
  ...
  `id_name` varchar(100) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `incomerange` (
  ...
  `income_range` varchar(50) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `occupation` (
  ...
  `occupation_name` varchar(100) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `queue` (
  ...
  `step` int NOT NULL,
  `status` enum('Waiting','Serving','Completed') COLLATE utf8_general_ci DEFAULT 'Waiting',
...
CREATE TABLE `religions` (
  ...
  `religion_name` varchar(50) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `user_name` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `user_pass` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `user_role` enum('Admin','Admin Clerk 1','Admin Clerk 2','Admin Clerk 3','Social Worker','SDO') COLLATE utf8_general_ci DEFAULT NULL,
...
-- Dump completed on 2025-04-01 15:11:52
