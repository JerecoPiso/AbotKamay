CREATE DATABASE  IF NOT EXISTS `tqsystemdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tqsystemdb`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: tqsystemdb
-- ------------------------------------------------------
...
CREATE TABLE `assessmentinformation` (
  ...
  `problem_presented` text COLLATE utf8mb4_general_ci,
  `social_worker_assessment` text COLLATE utf8mb4_general_ci,
  `client_category` int NOT NULL,
  `client_sub_category` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `assessmentinformation` VALUES (8,1,1,'7','767',2,'67','2025-03-16 07:39:11'),(9,2,2,'rt','rtert',2,'4545','2025-03-16 07:48:06'),(10,2,2,'xxgfdf','dfgdfg',2,'dfgdfg','2025-03-16 11:36:17');
...
CREATE TABLE `assistanceinformation` (
  ...
  `referral_specify` text COLLATE utf8mb4_general_ci,
  `other` text COLLATE utf8mb4_general_ci,
  `amount` decimal(10,2) DEFAULT NULL,
  `mode_of_assistance` enum('Cash','GL') COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `specify` text COLLATE utf8mb4_general_ci,
  `value_pesos` decimal(10,2) DEFAULT NULL,
  `fund_source` text COLLATE utf8mb4_general_ci,
  ...
  `material_specify` text COLLATE utf8mb4_general_ci,
  `material_value_pesos` decimal(10,2) DEFAULT NULL,
  `payee_name` text COLLATE utf8mb4_general_ci,
...
INSERT INTO `assistanceinformation` VALUES (1,1,0,1,0,NULL,NULL,5656.00,'GL',0,0,0,0,'',0.00,'',NULL,1,0,0,'RTRT',0.00,'GGGG GGGGGGGG','TRT'),(2,1,0,1,0,NULL,NULL,767.00,'Cash',1,0,0,0,'767',67.00,'76767',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG','6767'),(3,1,0,1,0,NULL,NULL,767.00,'Cash',1,0,0,0,'767',67.00,'76767',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG','6767'),(4,1,0,1,0,NULL,NULL,767.00,'Cash',1,0,0,0,'6767',7.00,'767667',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG','6767'),(5,1,0,1,0,NULL,NULL,667.00,'Cash',1,0,0,0,'trt',0.00,'rtr',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG',''),(6,1,0,1,0,NULL,NULL,667.00,'Cash',1,0,0,0,'trt',0.00,'rtr',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG',''),(7,1,1,1,0,NULL,NULL,67.00,'Cash',0,0,0,0,'',0.00,'',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG',''),(8,2,2,1,0,NULL,NULL,54545.00,'Cash',1,0,0,0,'45',5.00,'5',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG',''),(9,2,2,1,0,NULL,NULL,546756.00,'Cash',0,0,0,0,'',0.00,'',NULL,0,0,0,'',0.00,'GGGG GGGGGGGG','');
...
CREATE TABLE `beneficiaryfamilycomposition` (
  ...
  `civil_status` enum('Single','Married','Other') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `civil_status_other` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `beneficiaryfamilycomposition` VALUES (1,2,'GGGG','GGGG','','2025-03-16',0,'Male','455','Single',NULL,1,2);
...
CREATE TABLE `beneficiaryinformation` (
  ...
  `client_id` int DEFAULT NULL,
  `beneficiary_type` set('FHONA','Solo Parent','PWD','4Ps','Others') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `other_beneficiary_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `youth_senior` set('Youth','Senior Citizen') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `last_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `first_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `middle_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ext_name` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sex` enum('Male','Female') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `date_of_birth` date DEFAULT NULL,
  `age` int DEFAULT NULL,
  ...
  `street_purok` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `clientinformation` (
  ...
  `barangay` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `street_purok` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `relationship_to_beneficiary` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `civil_status` enum('Single','Married','Other') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `civil_status_other` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nationality` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `skills_occupation` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `philhealth_no` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mode_of_admission` enum('Walk-in','Referral') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `referring_party` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `contact_number` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `last_assistance_date` date DEFAULT NULL,
...
CREATE TABLE `idtypes` (
  ...
  `id_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `incomerange` (
  ...
  `income_range` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `occupation` (
  ...
  `occupation_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `queue` (
  ...
  `step` int NOT NULL,
  `status` enum('Waiting','Serving','Completed') COLLATE utf8mb4_general_ci DEFAULT 'Waiting',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `queue` VALUES (2,2,5,'Completed','2025-02-12 16:36:38'),(3,3,5,'Completed','2025-02-12 16:38:18'),(4,4,5,'Serving','2025-02-12 16:39:05'),(7,5,4,'Completed','2025-02-12 19:17:37'),(10,6,3,'Completed','2025-02-24 01:00:05'),(11,7,2,'Waiting','2025-02-24 01:00:22');
...
CREATE TABLE `religions` (
  ...
  `religion_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `user_pass` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `user_role` enum('Admin','Admin Clerk 1','Admin Clerk 2','Admin Clerk 3','Social Worker','SDO') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'administrator','Adminp@55','Admin','2025-03-05 21:17:42','John','Doe'),(2,'socialworker1','Worker1p@55','Social Worker','2025-03-16 19:38:13','Lito','Ramos'),(3,'socialworker2','Worker2p@55','Social Worker','2025-01-01 09:54:13','Joan','Lopez'),(4,'socialworker3','Worker3p@55','Social Worker','2025-01-01 09:54:13','Sheila','Guantero'),(5,'socialworker4','Worker4p@55','Social Worker','2025-01-01 10:28:17','Sarah Joy','Pino'),(7,'clerk1','Cl3rk111','Admin Clerk 1','2025-02-24 08:53:48','Maria Clara','Santos'),(8,'clerk2','Cl3rk222','Admin Clerk 2','2025-02-24 09:12:31','Jose','Garcia'),(9,'clerk3','Cl3rk333','Admin Clerk 3','2025-03-16 15:00:21','Ana','Villanueva'),(10,'disbursementofficer','D!55bursement','SDO','2025-02-24 12:03:41','Faye','Bonifacio');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'tqsystemdb'
--

--
-- Dumping routines for database 'tqsystemdb'
--
...
-- Dump completed on 2025-03-16 19:41:02
